...
class AirportManager:
    ...
    def resolve_all(self, query: str, *, filter_inactive: bool = True) -> list[str]:
        ...
        # 2b. Compound airport phrases such as "上海虹桥" or
        # "长春龙嘉" should still resolve to the exact airport alias.
        for alias, iata in self._alias_index.items():
            if alias and (alias in q_lower or alias in q_nospace):
                return [iata]
